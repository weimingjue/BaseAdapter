 ...
 */
public abstract class BaseAdapterLvsListCycle<DB extends ViewDataBinding, BEAN> extends BaseAdapterLvs
    ...
    public BaseAdapterLvsListCycle(@LayoutRes int layoutId, @Nullable List<BEAN> list) {
